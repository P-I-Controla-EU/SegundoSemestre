...
class Pagamento
{
    ...
    public function __construct($idPagamento = 0, $assinaturaId = 0, $formaPagamento = "", $statusPagamento = "") {
    ...
    public function getAssinaturaId() { return $this->assinaturaId; }
    public function setAssinaturaId($assinaturaId) { $this->assinaturaId = $assinaturaId; }
    ...
    public function setFormaPagamento($formaPagamento) { $this->formaPagamento = $formaPagamento; }
    ...
    public function getIdExterno() { return $this->idExterno; }
    public function setIdExterno($idExterno) { $this->idExterno = $idExterno; }
