...
class Historico
{
    ...
    public function __construct($idTransacao = 0, $pessoaId = 0, $descricao = "", $valor = 0.0) {
    ...
    public function getIdTransacao() { return $this->idTransacao; }
    public function setIdTransacao($idTransacao) { $this->idTransacao = $idTransacao; }
    ...
    public function getDataMovimentacao() { return $this->dataMovimentacao; }
    public function setDataMovimentacao($dataMovimentacao) { $this->dataMovimentacao = $dataMovimentacao; }
    ...
    public function getStatusTransacao() { return $this->statusTransacao; }
    public function setStatusTransacao($statusTransacao) { $this->statusTransacao = $statusTransacao; }
    ...
    public function setMetaId($metaId) { $this->metaId = $metaId; }

    public function getDataTermino() { return $this->dataTermino; }
    public function setDataTermino($dataTermino) { $this->dataTermino = $dataTermino; }

    public function getDataCobrancaRec() { return $this->dataCobrancaRec; }
    public function setDataCobrancaRec($dataCobrancaRec) { $this->dataCobrancaRec = $dataCobrancaRec; }
