        ...
        <div class="row g-4 mt-5">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="plan-card security-card fade-up">
              ...
              <a href="index.php?controle=AuthController&metodo=cadastro" class="btn btn-white plan-btn">Assinar Starter<i data-lucide="arrow-right" class="icon-sm"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="plan-card plan-featured gradient-primary shadow-glow scale-up fade-up" style="transition-delay: 0.08s;">
              ...
              <a href="index.php?controle=AuthController&metodo=cadastro" class="btn btn-white plan-btn">
