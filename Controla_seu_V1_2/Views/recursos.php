...
<head>
    ...
    <title>Recursos - Controla$EU</title>
    <meta name="description" content="Controle receitas, despesas, orçamentos e metas em um só lugar." />
...
<div class="container section-padding">
  <div class="section-header text-center fade-up">
    ...
    <p class="section-subtitle-center mx-auto">Ferramentas pensadas para quem está começando a vida financeira — sem jargão, sem planilha.</p>
  </div>
...
<footer class="site-footer">
  <div class="container">
    <div class="footer-bottom-content pt-4 pb-4">
